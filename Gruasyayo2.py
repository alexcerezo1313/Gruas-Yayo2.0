...
if not resultados:
    ...
    # Función para colorear filas según el "Tipo" (usando el campo interno de cada candidato)
    def color_rows(row):
    ...
    # Layout en columnas: la tabla a la izquierda y la imagen (ahora "a.png") a la derecha.
