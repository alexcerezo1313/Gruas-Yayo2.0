...
# Se han añadido las letras A y B delante de cada filtro
...
if use_intermedia:
    # Se han añadido las letras C y D a los filtros correspondientes
...
# --------------------------------------------------------------------
# Preparar la tabla de resultados (sin mostrar "Total Error" ni "Tipo")
if not resultados:
    ...
    # --------------------------------------------------------------------
    # Función para colorear filas según el "Tipo" (usamos el campo interno de cada candidato)
    def color_rows(row):
    ...
    # Usamos un layout de columnas para que la tabla quede a la izquierda y la imagen a la derecha.
    ...
    with col2:
        st.image("crane_diagram.png", use_column_width=True)
